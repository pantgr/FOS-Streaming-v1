...
packages_install(){
    ...
    wget https://www.dropbox.com/s/8xpfnmdq5dsdegv/fos-streaming_unpack_x84_64.tar.gz -O /home/fos-streaming/fos-streaming_unpack_x84_64.tar.gz  > /dev/null 2>&1
    ...
    git clone https://github.com/pantgr/FOS-Streaming-v1.git  > /dev/null 2>&1
